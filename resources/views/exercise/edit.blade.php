<x-app-layout>
    ...
    <div class="relative">
        ...
        <div class="overflow-y-auto overflow-x-hidden h-full">
            <form method="POST" action="{{ route('exercise.update', $exercise) }}">
                @csrf
                @method('PATCH')
                ...
                <fieldset class="fieldset mb-2 p-2">
                    ...
                    <textarea id="secondary_muscles" name="secondary_muscles"
                        class="textarea textarea-accent h-24 w-full"
                ...
                <div class="flex justify-between items-center m-4 px-4">
                    ...
                    <button type="submit" class="btn w-24 btn-primary">Update</button>
                </div>
            </form>
        </div>
    </div>
