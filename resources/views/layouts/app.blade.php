...
<body class="h-full min-h-screen">
    ...
    <div class="drawer">
        ...
        <div class="drawer-side z-50">
            ...
            <div class="flex flex-col h-full bg-base-200 w-80 p-2">
                <ul class="menu flex-grow text-base-content">
                    @auth
                ...
                <!-- Menu footer with the Version number -->
                <div class="flex justify-center items-center">
                    <p class="text-xs text-gray-500">RepRec Version: {{ config('app.version') }}</p>
                </div>
            </div>
        </div>
    </div>
